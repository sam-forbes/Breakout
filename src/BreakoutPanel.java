...
public class BreakoutPanel extends JPanel implements ActionListener, KeyListener {
	...
	public BreakoutPanel(Breakout game) {
		...
		// TODO: Create a new ball object and assign it to the appropriate variable | #Completed 
			ball = new Ball();
		// TODO: Create a new paddle object and assign it to the appropriate variable | #Completed 
			paddle = new Paddle();
		// TODO: Create a new bricks array (Use Settings.TOTAL_BRICKS)|  #Completed 
		 	bricks = new Brick[Settings.TOTAL_BRICKS];	
		// TODO: Call the createBricks() method | #Completed 
		createBricks();
	...
	private void update() {
		if(gameRunning) {
			// TODO: Update the ball and paddle |# Completed 
			ball.update();
			paddle.update();
			collisions();
			repaint();
	...
	public void keyPressed(KeyEvent e) {
		// TODO: Set the velocity of the paddle depending on whether the player is pressing left or righ |#Completed
